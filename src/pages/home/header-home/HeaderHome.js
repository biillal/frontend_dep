    ...
    <div className="relative  z-30">
      ...
      <div className=' absolute top-0 lg:flex  lg:flex-row w-[90%] lg:items-center lg:h-[550px]  justify-around lg:w-[100%] '>
        ...
        <motion.div 
          ...
          className='lg:w-[50%] ml-7 lg:mt-0'>
      ...
      <motion.div
        ...
        whileTap={{scale:1.1}}
      >
        <Link to="/registrations" className='p-2 border border-blue-900 bg-blue-950 text-white rounded-lg hover:bg-blue-800'>Registration</Link>
      </motion.div>
    </div>
  )
}
